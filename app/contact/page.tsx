...
export default function Page() {
    ...
    <div>
      ...
      <iframe  allow="fullscreen" src="https://mixdentertainmentgroup.lumify.app/widget/contact-form/afa406af-a209-4964-9568-b0b2e1fdf52b/live"  height="500" width="500vh" ></iframe>
      </div>
      <Footer></Footer>
    </div>)
